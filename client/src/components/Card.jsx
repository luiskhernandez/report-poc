  ...
  return (
        <div
          ...
          className={classNames(
            ...
            'relative group border border-solid bg-gray-50 p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500'
          )}
        >
          <div>
            <span
              className={classNames(
                ...
                'rounded-lg inline-flex p-3 ring-4 ring-black'
              )}
            >
